...
<div class="banner"><small>Resume </small></div>
...
<div class="row">
	<!--<div class=" side">
		...
		<h1 style="color: #c19c6f;"> SQL Server</h1>
		...
		<p>
			...
			cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
			<i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="../page/python.php" class="pagelink">SQL + Python</a>
		</p> <br><br>
		...
		<p>
			...
			cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
			<i class="fa fa-arrow-right" aria-hidden="true"></i> <a href="../page/logo.php" class="pagelink">Simple and Standout Logos</a>
		</p> <br><br>
	...
	<div class="main">
		<h1>CV</h1>
		<h5>Please click image to download </h5>
		<p style="background-color: #fff; color: #140e0e;">
			
			
		</p>
		<button onclick="seeMore()"  class="seemore">Hide CV</button><br><br>
		

						<div id="getseemore"  class="cv">

						<a href="../image/dccv.pdf" download="DCeesay CV">
						 	<img src="../image/dc1.png" width="150" height="150">
						</a> <br>
						<p id="getmessage"></p> 
		...
		<script>
			...
			if (see.style.display === 'none') {
				...
				document.getElementById("getmessage").innerHTML="Download CV"
